...
//
//   const stateInCart = (name, code) => {
//     localStorage.getItem(`${name}${code}inCart`);
//   }
//
...
//         <Button className={styles.buttonAdd} text={buttons[0].text} onClick={setIsOpenModal(!isOpenModal)}/>
//
//         {isOpenModal ? <Modal
//           closeButton={isCloseModalBtn ? <Button onClick={closeModal} text={buttonModal[3].text}/> : null}
//           header={modalContent[0].title} text={modalContent[0].text} closeModal = {closeModal}
//           actions={
//             <>
...
//                 closeModal();
//               }}/>
//               <Button onClick={closeModal} text={buttonModal[1].text}/>
//             </>}/> : null}
//       </div>
//     )
// }
